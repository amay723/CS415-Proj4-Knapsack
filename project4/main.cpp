...
void dynamicOpt(int capacity, vector<int> weights, vector<int> values, ofstream & plots, string filenum);
void greedyOpt(int capacity, vector<int> weights, vector<int> values, ofstream & plots, string filenum);
...
int main() {
  ...
  string filename = "p0" + filenum + "_c.txt";
  ...
  ofstream plots("plots" +  filenum + ".txt");

  plots << values.size() << endl;

  dynamicOpt(capacity, weights, values, plots, filenum);
  cout << endl << endl;
  greedyOpt(capacity, weights, values, plots, filenum);
